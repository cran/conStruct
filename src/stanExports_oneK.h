...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'oneK', line 23, column 1 to column 21)",
                                                      " (in 'oneK', line 24, column 3 to column 29)",
                                                      " (in 'oneK', line 27, column 1 to column 20)",
                                                      " (in 'oneK', line 28, column 1 to column 32)",
                                                      " (in 'oneK', line 31, column 1 to column 22)",
                                                      " (in 'oneK', line 32, column 1 to column 34)",
                                                      " (in 'oneK', line 33, column 1 to column 29)",
                                                      " (in 'oneK', line 12, column 1 to column 16)",
                                                      " (in 'oneK', line 13, column 1 to column 16)",
                                                      " (in 'oneK', line 14, column 1 to column 18)",
                                                      " (in 'oneK', line 15, column 8 to column 9)",
                                                      " (in 'oneK', line 15, column 10 to column 11)",
                                                      " (in 'oneK', line 15, column 1 to column 20)",
                                                      " (in 'oneK', line 16, column 1 to column 19)",
                                                      " (in 'oneK', line 19, column 8 to column 9)",
                                                      " (in 'oneK', line 19, column 10 to column 11)",
                                                      " (in 'oneK', line 19, column 1 to column 21)",
                                                      " (in 'oneK', line 20, column 1 to column 23)",
                                                      " (in 'oneK', line 24, column 19 to column 20)",
                                                      " (in 'oneK', line 27, column 8 to column 9)",
                                                      " (in 'oneK', line 27, column 10 to column 11)",
                                                      " (in 'oneK', line 3, column 9 to column 10)",
                                                      " (in 'oneK', line 3, column 11 to column 12)",
                                                      " (in 'oneK', line 3, column 2 to column 21)",
                                                      " (in 'oneK', line 4, column 9 to column 10)",
                                                      " (in 'oneK', line 4, column 11 to column 12)",
                                                      " (in 'oneK', line 4, column 2 to column 22)",
                                                      " (in 'oneK', line 5, column 2 to column 33)",
                                                      " (in 'oneK', line 6, column 2 to column 32)",
                                                      " (in 'oneK', line 7, column 2 to column 20)",
                                                      " (in 'oneK', line 8, column 2 to column 16)",
                                                      " (in 'oneK', line 2, column 46 to line 9, column 2)"};
template <typename T1__, typename T2__>
Eigen::Matrix<stan::promote_args_t<stan::value_type_t<T1__>,
T2__>, -1, -1>
Cov(const int& N, const T1__& nugget_arg__, const T2__& gamma,
  ...
  try {
    ...
    assign(parCov, nil_index_list(), rep_matrix(gamma, N, N),
    ...
    assign(parCov, nil_index_list(),
      add(stan::model::deep_copy(parCov), Nug_mat),
      "assigning variable parCov");
...
Eigen::Matrix<stan::promote_args_t<stan::value_type_t<T1__>,
T2__>, -1, -1>
operator()(const int& N, const T1__& nugget, const T2__& gamma,
...
class model_oneK final : public model_base_crtp<model_oneK> {
private:
  int K;
  int N;
  int L;
...
public:
  ...
  inline std::string model_name() const final { return "model_oneK"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_oneK_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      assign(parCov, nil_index_list(), Cov(N, nugget, gamma, pstream__),
        "assigning variable parCov");
      {
...
(void) function__;  // suppress unused var warning
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"gamma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"nugget\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"parameters\"},{\"name\":\"parCov\",\"type\":{\"name\":\"matrix\",\"rows\":" << N << ",\"cols\":" << N << "},\"block\":\"transformed_parameters\"}]";
    return s__.str();
...
using stan_model = model_oneK_namespace::model_oneK;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_oneK_namespace::profiles__;
}
#endif
#endif
